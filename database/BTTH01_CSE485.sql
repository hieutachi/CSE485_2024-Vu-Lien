...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 18, 2024 lúc 01:19 PM
...
ALTER TABLE `baiviet`
  ...
  ADD KEY `FK_tloai` (`ma_tloai`),
  ADD KEY `FK_tgia` (`ma_tgia`);
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `FK_tgia` FOREIGN KEY (`ma_tgia`) REFERENCES `tacgia` (`ma_tgia`),
  ADD CONSTRAINT `FK_tloai` FOREIGN KEY (`ma_tloai`) REFERENCES `theloai` (`ma_tloai`);
COMMIT;
